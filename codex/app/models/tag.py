...
class TagModel(db.Model):
    ...
    tag_id = db.Column(db.String(KsuidMs.BASE62_LENGTH), primary_key=True, default=KsuidMs)
    ...
    file_id = db.Column(
        db.String(ShortKsuid.BASE62_LENGTH), db.ForeignKey("file.file_id"), nullable=False
    )
